...
export default {
  ...
  provide () {
    return {
      expandDepth: computed(() => this.expandDepth),
      timeformat: computed(() => this.timeformat),
      highlight: computed(() => this.highlight),
      searchCallback: computed(() => this.searchCallback)
    }
  },
  data () {
    return {
